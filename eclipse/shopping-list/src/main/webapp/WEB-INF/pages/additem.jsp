...
<title>Shopping List Add Item</title>
				...
				<div class="row">
					<div class="col-lg-6">
						<form:form id="addForm" method="post"
							class="bs-example form-horizontal" action="create"
							modelAttribute="item">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-lg-7">
										<form:input type="text" class="form-control" path="itemName"
											id="itemNameInput" placeholder="Item Name" />
								...
								<div class="form-group">
									...
									<div class="col-lg-7">
										<form:input type="text" class="form-control"
											path="itemPricePerItem" id="itemPricePerItemInput"
											placeholder="Item Price PER Item" />
								...
								<div class="form-group">
									...
									<div class="col-lg-7">
										<form:input type="text" class="form-control"
											path="itemQuantity" id="itemQuantityInput"
								...
								<div class="form-group">
									...
									<div class="col-lg-7">
										<form:input type="text" class="form-control"
											path="alternateItemName" id="alternateItemNameInput"
											placeholder="Alternate Item Name" />
